package com.raythonsoft.repository.codegen;
...
public class CodeGenerator {
    //JDBC配置
    private static String JDBC_URL = "jdbc:mysql://127.0.0.1:3306/auth";
    //    private static String JDBC_URL = "jdbc:mysql://localhost:3306/br_ois_dev";
    ...
    //注释
    private static String AUTHOR = "RAYTHONSOFT";//@author
